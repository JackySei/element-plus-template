(function (global, factory) {
  ...
  Output$3.prototype.ensure_empty_line_above = function (
    starts_with,
    ends_with
  ) {
  ...
  Options$9.prototype._get_selection = function (
    ...
    const result = this._get_selection_list(
      name,
      selection_list,
      default_value
    );
  ...
  Tokenizer$4.prototype._get_next_token = function (
    previous_token,
    open_token
  ) {
    // jshint unused:false
  ...
  Tokenizer$3.prototype._get_next_token = function (
    previous_token,
    open_token
  ) {
    // jshint unused:false
  ...
  Beautifier$5.prototype.print_token_line_indentation = function (
    current_token
  ) {
    if (this._output.just_added_newline()) {
      if (
  ...
  Tokenizer$1.prototype._get_next_token = function (
    previous_token,
    open_token
  ) {
    // jshint unused:false
  ...
  **/
  ...
  class JsMark {
    ...
    _onClick(e) {
      if (e.target !== null && 'dataset' in e.target) {
        ...
        if (selectorId) {
          ...
          this.onClick &&
            this.onClick({ uid: selectorId, offsetTop, offsetLeft });
        }
      }
    }
    ...
    _onMouseUp(e) {
      ...
      this._captureSelection(range, topPosition);
    }

    _captureSelection(range, topPosition) {
      const selection = this._selection;
      if (!selection) {
        return;
      }
