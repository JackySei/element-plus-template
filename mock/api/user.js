        ...
        children: [
          {
            ...
            children: [
              ...
              {
                name: 'Account',
                path: '/ecrs/admin/account',
                component: 'permission/account.vue',
                meta: {
                  title: '用户管理',
                },
              },
          ...
          {
            name: 'KWordmanager',
            path: '/ecrs/kwordmanager',
            component: 'kwordmanager/index.vue',
            ...
            children: [
              {
                name: 'KeyWords',
                path: '/ecrs/kwordmanager/keywords',
                component: 'kwordmanager/keywords.vue',
                meta: {
                  title: '关键词库',
                },
              },
              {
                name: 'TagConfig',
                path: '/ecrs/kwordmanager/tagconfig',
                component: 'kwordmanager/tagconfig.vue',
                meta: {
                  title: '标记配置',
                },
              },
          ...
          },
          {
            ...
            children: [
              {
                name: 'Check',
                path: '/ecrs/pgccheck/check',
                component: 'pgccheck/check.vue',
                meta: {
                  title: 'PGC审核',
                },
              },
              {
                name: 'Search',
                path: '/ecrs/pgccheck/search',
                component: 'pgccheck/search.vue',
                meta: {
                  title: '历史搜索',
                },
              },
...
export default {
  'get|/api/pgc/auth/getMenus': (option) => {
    return {
      status: 200,
      message: 'success',
      data: userMenu,
  ...
  'get|/api/pgc/rolemanage/getRoles': (option) => {
    return {
      status: 200,
      message: 'success',
      data: roleMenu,
  ...
  'get|/api/pgcauth/rolemanage/getUserWithoutCurRole': (option) => {
    return {
      status: 200,
      message: 'success',
      data: userMenu,
